#Funcion
Yolov5 for person filtering of rootdir/subdir/*.jpg

#Torun
run_shot_person_dir.sh testimg_person 
python get_shot_nonperson_imgdir.py testimg_person testimg testimg_class
